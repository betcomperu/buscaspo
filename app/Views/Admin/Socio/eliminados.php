...
<div class="content-wrapper">
    ...
    <div class="card-body">
        <div class="box-header with-border">
            ...
            <a href="<?php echo base_url(); ?>/panel/socio" class="btn btn-info"><i class="fas fa-list-ol"></i> Lista Socios 
            </a>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('panel/restaurar/' . $dato['idSocio']) ?>">Restaurar</a>
